...
class AuthenticationController extends Controller
{
    public function isGuestLoggedInAction()
    {
        ...
        $id = $_SESSION['mirrormx_customer_chat']['guest']['id'];
        if(isset($_SESSION['mirrormx_customer_chat']['guest']))
        {
            return $this->json(array(

                'success' => true,
                'name'    => substr($_SESSION['mirrormx_customer_chat']['guest']['name'], 0, strrpos($_SESSION['mirrormx_customer_chat']['guest']['name'], '-', -1)),
                'mail'    => $_SESSION['mirrormx_customer_chat']['guest']['mail'],
                'image'   => $_SESSION['mirrormx_customer_chat']['guest']['image']
            ));
        }
        if($id !== null)
        {
