...
class MessageModel extends Model
{
    ...
    const NEW_TALK_TIME_DELAY      =  90000; // how long does it take to group message in a separate talk: 15 minutes (in seconds)
    const LAST_MESSAGES_TIME_DELAY = 360000; // maximum age of previous messages displayed in the current talk: 1 hour (in seconds)
    ...
    public function generateTalkId()
    {
        ...
        if (isset($_SESSION['User']['chat_id']))
            return $_SESSION['User']['chat_id'];
