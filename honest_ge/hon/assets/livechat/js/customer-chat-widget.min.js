!(function (t, e) {
    t.Application = e.extend({ model: {}, view: {}, service: {}, template: {} }, Backbone.Events);
})(window, _),
    (function (t, e, s) {
                    ...
                    if (
                        ((i.play = function (t) {
                            ...
                            (i.addSounds = function (t) {
                                for (var i in t) e.createSound({ id: i, url: s.rootPath + t[i], autoLoad: !0, autoPlay: !1, volume: 100 });
                            }),
                            i.addSounds({ message: s.ui.messageSound }),
                        t.length > 0)
                    )
    ...
    (function (t, e) {
        t.GuestSettingsModel = Backbone.Model.extend({
            defaults: { sound: !0, scroll: !0, emots: !0, show: !0 },
            initialize: function () {
    ...
    (function (t, e) {
        t.MessageModel = Backbone.Model.extend({
            ...
            initialize: function (t, e) {
                if (((this.options = e || {}), t)) {
                    if (
                        ("string" == typeof t.datetime ? this.set("time", new Date(t.datetime.replace(/-/g, "/"))) : "object" == typeof t.datetime && this.set("time", t.datetime),
        ...
        var o = (t.GuestChatModel = Backbone.Model.extend(
            {
                ...
                autoLogin: function () {
                    var t = this;
                    e.post(s.isLoggedInPath, { info: JSON.stringify(s.info) }, function (i) {
                        i.success
                            ? (t.set({ name: i.name, mail: i.mail, image: i.image }),
                ...
                login: function (t) {
                    ...
                    (t.info = JSON.stringify(s.info)),
                        e.post(s.loginPath, t, function (e) {
                            e.success ? (i.set({ name: t.name, mail: t.mail, image: t.image }), i.trigger("login:success")) : i.trigger("login:error");
                        });
                },
                logout: function () {
                    this.stopConnectionManagement();
                    var i = this;
                    this.sendMessage(new t.MessageModel({ body: "[ user has closed the chat ]" }), function () {
                ...
                updateTypingStatus: function () {
                    ...
                    if (t) {
                        ...
                        this.lastTypingUpdate + o.POLLING_INTERVAL < i && ((this.lastTypingUpdate = i), e.post(s.updateTypingStatusPath, { secondUserId: t, status: !0 }));
                    }
                },
                getTypingStatus: function (t) {
                    ...
                    if (i) {
                        var o = this,
                            n = e.post(s.getTypingStatusPath, { ids: [i] }, function (t) {
                ...
                getMessages: function (t) {
                    var i = this,
                        o = e.get(s.newMessagesPath, function (t) {
                            t.length > 0 &&
                            i.loadOperatorsData(t, function () {
                ...
                confirmMessagesRead: function (t) {
                    var t = { firstId: t[0].id, lastId: t[t.length - 1].id };
                ...
                loadOperatorsData: function (t, i) {
                    for (var o = this, n = 0, a = 0; a < t.length; a++) {
                        var h = t[a];
                        this.operatorsCache[h.from_id] ||
                        (n++,
                            e
                                .post(s.getOperatorPath, { id: h.from_id })
                                .success(function (t) {
                ...
                initRequestsStatus: function () {
                    (this.requestInitTime = Date.now()), (this.requestsStatus = { getMessages: !0, keepAlive: !0, getTypingStatus: !0, checkOperators: !0 });
                },
            ...
            { POLLING_INTERVAL: 5e3, REQUEST_STATUS_RESET_TIMEOUT: 2e4 }
        ));
            ...
            o = (t.MessageView = Backbone.View.extend(
                {
                    ...
                    render: function () {
                        ...
                        (e = this.prepareMessage(e)),
                            ...
                            this.updateTime(!0),
                        "operator" == this.model.get("authorType") &&
                        ...
                        t.UserInfoPopoverView && new t.UserInfoPopoverView({ model: this.model, button: this.$(".customer-chat-content-message-author")[0] });
                    },
                    prepareMessage: function (t) {
                        if (
                            ((t = t.replace(i, function (t, e) {
    ...
    (function (t, e) {
        t.ChatBoxView = Backbone.View.extend({
            ...
            addMessage: function (e, s, i) {
                var o = new t.MessageView({ model: e, fullDate: this.options.fullDate });
        ...
        var i = (t.WidgetView = Backbone.View.extend(
            {
                ...
                initialize: function () {
                    (this.settings = t.model.settings),
                        (this.loginForm = new t.LoginFormView({ el: this.$("#customer-chat-content-login-form") })),
                        (this.chatBox = new t.ChatBoxView({ el: this.$(".customer-chat-content-messages") })),
                        (this.contactForm = new t.ContactFormView({ el: this.$("#customer-chat-content-contact-form") })),
                        (this.selectAvatar = new t.SelectAvatarInlineView({ el: this.$("#customer-chat-select-avatar"), model: s.defaultAvatars })),
                ...
                setState: function (e) {
                    if (this.state != e)
                        switch (((this.state = e), this.$settings.hide(), this.$emoticons.hide(), this.$el.removeClass("login-form chat-box contact-form loading-screen info-screen"), e)) {
                            case "loading":
                            ...
                            case "chat":
                                ...
                                for (var i = 0; i < this.model.lastMessages.length; i++) {
                                    var o = this.model.lastMessages[i],
                                        n = new t.MessageModel({ authorType: o.authorType, author: "guest" === o.authorType ? o.author : this.model.getOperatorName(o.from_id), body: o.body, time: new Date(o.datetime) });
                ...
                login: function () {
                    this.manualLogin = !0;
                    var t = { name: this.$loginName.val(), mail: this.$loginMail.val(), image: this.selectAvatar.selected };
                ...
                handleMessages: function (s) {
                    ...
                    this.$mobileTitle.is(":visible") && (this.stopTitleBlink(), this.startTitleBlink()),
                ...
                _sendMessage: function (e) {
                    if (0 != e.length) {
                        var s = new t.MessageModel({ author: this.model.get("name"), authorType: "guest", body: e, time: new Date(), from_user_info: { image: this.model.get("image") } }, { localMessage: !0 });
                ...
                sendContactMessage: function () {
                    var t = { name: this.$contactName.val(), mail: this.$contactMail.val(), question: this.$contactMessage.val(), userInfo: JSON.stringify(s.info) };
                ...
                showWelcomeMessage: function () {
                    var e = new t.MessageModel({ authorType: "operator", author: s.ui.initMessageAuthor, body: s.ui.initMessageBody, time: new Date() });
            ...
            { TYPING_STATUS_TIME: 2e3, ANIMATION_TIME: 400 }
        ));
    })(window.Application, jQuery, window.chatConfig),
    (function (t, e, s) {
        t.SelectAvatarInlineView = Backbone.View.extend({
            events: { "mousedown .prev-avatar": "prev", "mousedown .next-avatar": "next" },
            selectedIndex: 0,
            initialize: function () {
    ...
    jQuery(function (t) {
        ...
        t.get(e.templatesPath, function (e) {
            ...
            (i.service.soundPlayer = new i.SoundPlayer()),
                ...
                (i.view.widget = new i.WidgetView({ el: "#customer-chat-widget", model: i.model.chat })),
